...
Technologies ***Typescript, CSS, REACT+Vite, Github API, Fetch*** Key Features: GitHub API which provides functionality for searching users and repositories on GitHub.
